...
</br><img src="/Artificial_Intelligence/Project_3/img/ai3_0.jpg"  width=60% height=60%>
- **언어**: C++
- **스크린샷** (not linearly separable한 data set만 첨부)
  - 프로그램 시작 화면
  </br><img src="/Artificial_Intelligence/Project_3/img/ai3_1.JPG"  width=65% height=65%>
  
#### XOR gate
- 초기 값
</br><img src="/Artificial_Intelligence/Project_3/img/ai3_XOR_1.JPG"  width=65% height=65%>
- 결과 값
</br><img src="/Artificial_Intelligence/Project_3/img/ai3_XOR_2.JPG"  width=65% height=65%>
- 그래프
  - Layer 1
...
- 에러율
</br><img src="/Artificial_Intelligence/Project_3/img/ai3_XOR_error.JPG"  width=65% height=65%>
  
#### DOUGHNUT data
- 초기 값
</br><img src="/Artificial_Intelligence/Project_3/img/ai3_DOUGHNUT_1.JPG"  width=65% height=65%>
- 결과 값
</br><img src="/Artificial_Intelligence/Project_3/img/ai3_DOUGHNUT_2.JPG"  width=65% height=65%>
- 그래프
  - Layer 1
...
- 에러율
</br><img src="/Artificial_Intelligence/Project_3/img/ai3_DOUGHNUT_error.JPG"  width=65% height=65%>
